...
export default function Enter() {
  ...
  return (
    <div className="mt-16 px-4">
      <h3 className="text-center text-3xl font-bold">Enter to Live Commerce</h3>
      <div className="mt-8">
        ...
        <div className="mt-8">
          ...
          <div className="mt-2 grid grid-cols-2 gap-3">
            <button className="shadow-sm-400 flex items-center justify-center rounded-md border border-gray-300 bg-white  py-2 px-4 font-medium  text-gray-400 transition duration-300 ease-in-out hover:bg-gray-50">
              <svg
                className="h-5 w-5"
                aria-hidden="true"
                fill="currentColor"
